  ...
  const handleNumChange = (e) => {
    ...
    <Container>
      <Content>
        <Header>
          <Title>作業名稱：</Title>
          <InputTitle value={title} onChange={handleTitleChange}></InputTitle>
        </Header>
        <TotalQuestions>
          共有
          <InputQuestion value={num} onChange={handleNumChange}></InputQuestion>
          大題
        </TotalQuestions>
        <Actions>
          <Button onClick={props.handleCloseMask}>返回</Button>
